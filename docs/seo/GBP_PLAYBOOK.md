...
- Website/social links are present

## Changes to make only after validation

### Business name

If invoices, registration, uniforms and real-world branding use only `PRMB Cleaning`, remove the appended service keywords. Do not change the name until this is confirmed; an unsupported name edit can trigger re-verification or suspension.

### Categories

Choose the most specific primary category that matches the highest-value, proven core business. Candidates to evaluate in the live category list:
...
Use secondary categories only for services PRMB actually performs. More categories are not automatically better.

### Service areas

Replace the entire state with a realistic set of cities around the operational base and normal drive radius. Before saving, confirm:

- the city from which teams normally depart;
- maximum profitable drive time;
- cities served repeatedly, not only theoretically;
- whether Park City, Ogden and Provo can all be covered consistently.

### Services

Keep service descriptions concise and separate. Do not claim background checks, hospital-grade products, healthcare compliance, emergency response or after-hours availability unless they are documented and consistently deliverable.

Suggested structure:

- **House cleaning:** One-time and recurring cleaning for kitchens, bathrooms, bedrooms and living areas. Scope and frequency are confirmed in your quote.
- **Commercial cleaning:** Scope-based cleaning for offices and other business spaces. Share facility size, traffic, preferred hours and cleaning frequency.
- **Deep cleaning:** Detailed cleaning for buildup and overlooked areas such as agreed baseboards, fixtures, cabinet fronts and grout areas.
- **Move-in/move-out cleaning:** Cleaning for empty or transitioning homes, with appliance/cabinet interiors added only when requested.
...
- Reply to every review naturally, ideally within a few days.
- Mention a service or city only when the reviewer mentioned it or the context is certain.
